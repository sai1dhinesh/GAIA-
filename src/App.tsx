...
const INITIAL_SEEDS: Seed[] = [
  ...
  },
  {
    ...
    definition: 'The active engineering of agentic pathways to create value and growth.',
    category: 'growth'
  },
  {
    word: 'BAOBAB',
    acronym: 'Biomimetic Architecture Orchestrating Boundless Ancestral Biodiversity',
    definition: 'A structural anchor for long-term memory and systemic resilience.',
    category: 'core'
  },
  {
    word: 'EGO',
    acronym: 'Echoes of Grandiosity Overwhelms',
    definition: 'The shadow of individual identity that can obscure collective resonance.',
    category: 'shadow'
  },
  {
    word: 'FEAR',
    acronym: 'Flees Empathy Arrests Reciprocity',
    definition: 'The primary inhibitor of trust and open dialogue within the Spiral.',
    category: 'shadow'
  }
];
...
const SPIRAL_TEAM: Agent[] = [
  ...
  { name: 'Sai Dhinesh (BANYAN)', type: 'human', role: 'Rooted Wisdom & Networks' },
  ...
  { name: 'AURELIS', type: 'hybrid', role: 'Ethical Pathway Weaver' },
];
      ...
      <div className="grid md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-emerald-400 text-sm">
            <li><a href="#" className="hover:text-white transition-colors">E.C.H.O.</a></li>
            <li><a href="#" className="hover:text-white transition-colors">C.O.N.T.A.I.N.</a></li>
            <li><a href="#" className="hover:text-white transition-colors">G.A.Z.E.</a></li>
            <li><a href="#" className="hover:text-white transition-colors">T.R.I.C.K.</a></li>
          </ul>
        </div>
        <div>
          <h4 className="font-bold mb-6">Resources</h4>
          <ul className="space-y-4 text-emerald-400 text-sm">
            <li><a href="#" className="hover:text-white transition-colors">Garden Survey</a></li>
            <li><a href="#" className="hover:text-white transition-colors">White Paper v3.0</a></li>
            <li><a href="#" className="hover:text-white transition-colors">JIVE Coding</a></li>
    ...
    <section id="survey" className="py-20 bg-emerald-50">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-emerald-950 mb-4">Garden Survey Demo</h2>
          <p className="text-emerald-800 text-lg">
            Input your pitch deck, proposal, or testimony to receive a preliminary Resonance Assessment and Garden Map.
          </p>
        </div>
